	...
	<div class="container">
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				...
				<span class="h1 text-uppercase text-primary bg-dark px-2">XYZ</span> 
...
@foreach ( getCategories() as $category)
					...
					<li class="nav-item dropdown">
						...
						<!--	<li><a class="dropdown-item nav-link" href="#">Washing-Machines</a></li>
							<li><a class="dropdown-item nav-link" href="#">Air-Conditioners</a></li>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright 2024 XYZ Shop. All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
